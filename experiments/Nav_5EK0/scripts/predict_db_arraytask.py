...
class PredictArgs(Tap):
    ...
    run_platform: str="auto" #Literal["gpu", "pbs", "auto"], I need "auto" to be default
    i_iter: int
    fplist: str
...
def load_model(model, args: PredictArgs, model_args: VanillaModelArgs=None):
    ...
    elif args.run_platform == "pbs":
        if torch.cuda.is_available():
            print("Warning: GPU is available but running on PBS CPU is specified.")
