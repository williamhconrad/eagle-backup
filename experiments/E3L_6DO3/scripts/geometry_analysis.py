...
def analyze_top_pdbs(configfn, mode="pbs"):
    config = load_configfn(configfn)
    prefix="substructure"
    inpath = f"../top_cluster_pdbs/{prefix}/top1000_pdbs_all_ligand"
    outpath = f"../top_cluster_pdbs/{prefix}/top1000_ligand_geometry_analysis"
