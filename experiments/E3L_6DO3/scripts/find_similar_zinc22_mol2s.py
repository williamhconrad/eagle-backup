...
def find_substructure_in_db(molid, smarts_incl, smarts_excl, configfn, outdirname="substructure_mols", use_pbs=True):
...
def find_substructure_match():
    ...
    find_substructure_in_db(molid, smarts_incl, smarts_excl, configfn, outdirname, use_pbs)
